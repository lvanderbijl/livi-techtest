...
set CLASSPATH=%APP_HOME%\lib\lv.codeassignment-1.0.0-SNAPSHOT-fat.jar

@rem Execute lv.codeassignment
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LV_CODEASSIGNMENT_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
